...
src/builtins/cd.c        src/builtins/pwd.c   src/parse/parse.c     src/parse/parseSegmentsConditions.c  src/parse/utils_is.c    src/utils/debug_utils.c  src/utils/utils1.c 	src/builtins/built_in.c	src/builtins/env/env.c  src/builtins/env/export.c  src/builtins/env/utils.c \
src/executor/executor.c	src/executor/utils.c src/executor/heredoc.c
...
$(NAME):	$(OBJ) | $(OBJ_DIR)
	...
	@$(CC) $(CFLAGS) -o $(@) -lreadline -I /usr/local/include $(LDFLAGS) $(^) $(LIBFT_A)
